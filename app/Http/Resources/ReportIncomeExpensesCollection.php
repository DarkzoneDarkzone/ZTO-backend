...
class ReportIncomeExpensesCollection extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'shipping_lak' => $this->shipping_lak ? $this->shipping_lak : ($this->payment_no ? $this->amount_lak : '-'),
            'shipping_cny' => $this->shipping_cny ? $this->shipping_cny : ($this->payment_no ? $this->amount_cny : '-'),
